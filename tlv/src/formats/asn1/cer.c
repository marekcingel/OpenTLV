...
const tlv_reader_format_t tlv_reader_format_cer = {
    .context = NULL,
...
const tlv_writer_format_t tlv_writer_format_cer = {
    .context = NULL,
...
tlv_result_t tlv_cer_tag_make(tlv_asn1_class_t tag_class, int constructed,
    ...
    if (cer_write_tag(NULL, NULL, 0, &result, &written) != TLV_OK)
        return TLV_ERR_INVALID_TAG;
    *tag = result;
    return TLV_OK;
}
