# Format trees and byte examples

[Back to documentation](README.md)

Examples live with their implementation documentation. Bytes are hexadecimal;
explained lengths are decimal. Trees describe wire fields and logical nesting,
not allocated C objects.

- [Default TLV](formats/default/README.md#byte-example)
