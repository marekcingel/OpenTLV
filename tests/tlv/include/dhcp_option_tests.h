...
void dhcp_option_tests() {
  RUN_TEST(dhcp_option_1_test);
  RUN_TEST(dhcp_option_3_test);
  RUN_TEST(dhcp_option_6_test);
  RUN_TEST(dhcp_option_12_test);
}
