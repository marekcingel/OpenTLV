...
TEST(TLVTypes, zero_initialization_produces_empty_view) {
    tlv_view_t empty{};
...
TEST(TLVTypes, tag_stores_raw_bytes_at_every_supported_size) {
    tlv_tag_t tag{};
...
TEST(TLVTypes, buffer_borrows_byte_range) {
...
TEST(TLVTypes, copying_view_copies_tag_and_borrows_value) {
    uint8_t storage[] = {0x12, 0x34, 0x56};
...
TEST(TLVTypes, result_distinguishes_success_from_error) {
