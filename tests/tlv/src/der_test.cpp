...
TEST(Der, TagClassesNumbersAndForms) {
...
TEST(Der, CanonicalLengthBytesAndRoundTrip) {
...
TEST(Der, InvalidFieldsHaveOffsetsAndPreserveOutputs) {
...
TEST(Der, UniversalPrimitiveConstructedRules) {
...
TEST(Der, NestedTraversalAndEncoding) {
...
TEST(Der, LimitsAndWriterValidation) {
...
TEST(Der, DeepNestingUsesBoundedTraversal) {
...
TEST(Der, BerCompatibilityAndGenericFormat) {
...
TEST(Der, TagCapacityAndNumericOverflow) {
...
TEST(Der, EmptyArgumentsAndVisitorControl) {
    tlv_view_t view{};
