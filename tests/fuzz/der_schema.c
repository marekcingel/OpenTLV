...
static const tlv_der_schema_type_t kInteger = {TLV_DER_SCHEMA_UNIVERSAL, 2, NULL, 0, NULL, 0, 0};
static const tlv_der_schema_type_t kOctetString = {
    TLV_DER_SCHEMA_UNIVERSAL, 4, NULL, 0, NULL, 0, 0};
static const tlv_der_schema_type_t kBoolean = {TLV_DER_SCHEMA_UNIVERSAL, 1, NULL, 0, NULL, 0, 0};
...
static const tlv_der_schema_type_t kSet = {TLV_DER_SCHEMA_SET, 0, kSetMembers, 2, NULL, 0, 0};

static const tlv_der_schema_component_t kSetOfElement = {
    &kInteger, TLV_DER_TAG_NONE, TLV_ASN1_UNIVERSAL, 0, TLV_DER_REQUIRED, NULL, 0};
static const tlv_der_schema_type_t kSetOf = {TLV_DER_SCHEMA_SET_OF, 0, NULL,    0,
                                             &kSetOfElement,        0, SIZE_MAX};

static const tlv_der_schema_component_t kChoiceAlts[] = {
    {&kInteger, TLV_DER_TAG_NONE, TLV_ASN1_UNIVERSAL, 0, TLV_DER_REQUIRED, NULL, 0},
    {&kOctetString, TLV_DER_TAG_NONE, TLV_ASN1_UNIVERSAL, 0, TLV_DER_REQUIRED, NULL, 0},
};
static const tlv_der_schema_type_t kChoice = {TLV_DER_SCHEMA_CHOICE, 0, kChoiceAlts, 2, NULL, 0, 0};
...
static const tlv_der_schema_type_t kRoot = {
    TLV_DER_SCHEMA_SEQUENCE, 0, kRootComponents, 6, NULL, 0, 0};

static void check_der_schema(const uint8_t* data, size_t size,
    ...
    tlv_result_t rc = tlv_der_schema_read(data, size, &kRoot, limits, &view, &consumed, &error);
    if (rc == TLV_OK) {
...
int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    check_der_schema(data, size, NULL);
    check_der_schema(data, size, &limits);
