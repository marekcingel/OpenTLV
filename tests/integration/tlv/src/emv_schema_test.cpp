...
TEST(Integration_EmvSchema, AcceptsAnFciTemplateWithJustAMandatoryDfName) {
...
TEST(Integration_EmvSchema, RejectsAnFciTemplateMissingTheMandatoryDfName) {
...
TEST(Integration_EmvSchema, RejectsATagForbiddenDirectlyUnderTheFciTemplate) {
...
TEST(Integration_EmvSchema, RejectsADuplicateDfNameInsideOneFciTemplate) {
...
TEST(Integration_EmvSchema, RejectsADfNameShorterThanTheDictionaryMinimum) {
...
TEST(Integration_EmvSchema, AcceptsAnFciProprietaryTemplateNestedInsideTheFci) {
...
TEST(Integration_EmvSchema, AcceptsAnUnknownProprietaryTagInsideTheFciProprietaryTemplate) {
...
TEST(Integration_EmvSchema, AcceptsAGpoResponseFormat2WithExactlyAipAndAfl) {
...
TEST(Integration_EmvSchema, RejectsAGpoResponseFormat2MissingTheMandatoryAfl) {
    const std::vector<uint8_t> wire{0x77, 0x04, 0x82, 0x02, 0x19, 0x80};
    EXPECT_EQ(TLV_ERR_SCHEMA_MISSING, validate(wire));
}

TEST(Integration_EmvSchema, AcceptsUnmodeledTopLevelTagsUnchecked) {
...
TEST(Integration_EmvSchema, MissingFieldReportsTheDistinctCodeEvenWhenASiblingFollows) {
...
TEST(Integration_EmvSchema, AcceptsSeveralTopLevelTemplatesConcatenated) {
