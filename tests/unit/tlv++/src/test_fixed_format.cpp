...
TEST(Unit_TLV_CPP_FixedFormat, test_supported_configurations_round_trip) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_descriptors_have_static_storage_and_no_context) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_length_range_boundaries) {
    std::size_t size = 0;
...
TEST(Unit_TLV_CPP_FixedFormat, test_maximum_encodable_length_round_trips) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_empty_value_round_trips) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_truncated_input_is_rejected) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_reader_callbacks_report_short_fields) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_insufficient_output_capacity_is_reported) {
    using format = tlv::fixed_format<2, 2, BE>;
...
TEST(Unit_TLV_CPP_FixedFormat, test_tag_size_must_match_the_configured_width) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_multiple_elements_in_sequence) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_works_with_the_c_api) {
    using format = tlv::fixed_format<1, 2, BE>;
    std::uint8_t       buf[16] = {};
...
#if OPENTLV_FORMAT_FIXED_1BYTE
TEST(Unit_TLV_CPP_FixedFormat, test_one_byte_configuration_matches_the_builtin_format) {
...
TEST(Unit_TLV_CPP_FixedFormat, test_length_wider_than_size_t_is_rejected) {
