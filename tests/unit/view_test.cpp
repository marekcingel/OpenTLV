...
TEST(Unit_Tlv_View, ZeroInitializationProducesEmptyView) {
    tlv_view_t empty{};
...
TEST(Unit_Tlv_View, TagBorrowsRawBytesOfAnySize) {
...
TEST(Unit_Tlv_View, CopyingViewCopiesTheDescriptorsAndBorrowsTheBytes) {
...
TEST(Unit_Tlv_View, ResultDistinguishesSuccessFromError) {
