...
TEST(Unit_Tlv_Fixed1Byte, TruncationPreservesReaderAndOutput) {
...
TEST(Unit_Tlv_Fixed1Byte, InvalidWritesPreserveBufferAndPosition) {
    uint8_t data[258];
...
TEST(Unit_Tlv_Fixed1Byte, CallbacksRejectMissingBytes) {
