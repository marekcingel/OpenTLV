...
TEST(Unit_Tlv_Tag, IsAPointerAndASizeWithNoConfigurableCapacity) {
    struct borrowed {
        const uint8_t* data;
        size_t         size;
    };
...
TEST(Unit_Tlv_Tag, ConstructionBorrowsTheGivenBytes) {
...
TEST(Unit_Tlv_Tag, LiteralConstructionForSingleAndMultiByteTags) {
...
TEST(Unit_Tlv_Tag, LiteralsCanBeStoredAndCopied) {
...
TEST(Unit_Tlv_Tag, EqualComparesContentsNotPointers) {
...
TEST(Unit_Tlv_Tag, EqualRejectsDifferentBytesAndSizes) {
...
TEST(Unit_Tlv_Tag, EqualDetectsADifferenceInTheLastOfManyBytes) {
...
TEST(Unit_Tlv_Tag, EqualAndCompareAgreeOnValidTags) {
...
TEST(Unit_Tlv_Tag, CompareIsLexicographicByBytes) {
...
TEST(Unit_Tlv_Tag, CompareIsAntisymmetricAndBackedByAnyMemory) {
...
TEST(Unit_Tlv_Tag, TagsLongerThanTheFormerDefaultCapacity) {
    for (size_t size :
...
TEST(Unit_Tlv_Tag, HashAgreesWithEqual) {
    const std::vector<uint8_t> a = {0x9F, 0x02};
    const std::vector<uint8_t> b = {0x9F, 0x02};
...
TEST(Unit_Tlv_Tag, HashUsuallyDiffersForDifferentBytes) {
...
TEST(Unit_Tlv_Tag, CopyReportsRequiredSizeWithNullDestination) {
...
TEST(Unit_Tlv_Tag, CopyWritesBytesAndSupportsOverlap) {
...
TEST(Unit_Tlv_Tag, CopyRejectsInsufficientCapacityAndLeavesOutputsUnchanged) {
...
TEST(Unit_Tlv_Tag, CopyRejectsNullArguments) {
...
TEST(Unit_Tlv_Tag, TwelveByteTagFromRuntimeData) {
