...
check(2 "require dump" validate --format ber --hex AA --json)
...
foreach(pair IN ITEMS "DEFAULT|default" "FIXED|fixed-1byte" "BER|ber" "DER|der")
    ...
    check(0 "{\"length\":1,\"offset\":0,\"tag\":\"04\",\"value\":\"AA\"}" dump --format "${name}" --hex "0401AA" --json)
...
if(HAS_BER)
    ...
    check(0 "\"requested_length\":6,\"tag\":\"9F02\"" dump --format ber --pdol --json --hex "9F0206")
    if(HAS_EMV)
        check(0 "Amount Authorised" dump --format ber --pdol --hex "9F0206" --profile emv --describe)
        check(0 "\"name\":\"Amount Authorised\"" dump --format ber --pdol --json --profile emv --hex "9F0206")
    endif()
...
if(HAS_EMV)
    ...
    check(0 "\"decoded\":\"12345678\"" dump --format ber --hex "5A0412345678" --profile emv --decode --json)
else()
